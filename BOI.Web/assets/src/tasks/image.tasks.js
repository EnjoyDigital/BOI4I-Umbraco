module.exports = function (gulp, $) {
  ...
  gulp.task('sprite', function() {
    ...
    return gulp.src(['**/sprite-*.svg'], {
          ...
          mode : {
            ...
            */
            css : {
              ...
              render: {
                scss: {
                  dest: '../../assets/dist/css/maps/_svg-sprite.scss',
                  template: 'common/css/maps/_svg-sprite-template.scss',
                }
              }
            },
            /*
        ...
        .pipe(gulp.dest('.'))
        .pipe($.filter("common/images/sprite/*.svg"))
        .pipe($.raster())

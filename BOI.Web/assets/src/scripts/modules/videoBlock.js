...
function init() {
  // Inject SVG sprite if not already present
  if (!document.getElementById('plyr-svg-sprite')) {
    const div = document.createElement('div');
    div.innerHTML = plyrSvgSprite;
    div.firstChild.id = 'plyr-svg-sprite';

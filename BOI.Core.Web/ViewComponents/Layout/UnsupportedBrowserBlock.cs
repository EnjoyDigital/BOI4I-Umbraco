...
{
    public class UnsupportedBrowserBlock : ViewComponent
    {
        ...
        public UnsupportedBrowserBlock(IUmbracoContextAccessor umbracoContextAccessor, IUmbracoHelperAccessor umbracoHelperAccessor, ISessionManager sessionManager,
        ...
        public IViewComponentResult Invoke()
        {
            if (umbracoContextAccessor.GetRequiredUmbracoContext() is UmbracoContext umbracoContext)
            {
                ...
                if (currentPage != null)
                {
                    ...
                    return View("UnsupportedBrowserBlock", viewModel);
                }
            }
